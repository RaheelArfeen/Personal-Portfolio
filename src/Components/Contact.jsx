import { Github, Linkedin, Twitter, Send, GraduationCap, Laptop, Rocket, Star, Book, Phone } from "lucide-react";
...
const Contact = () => {
    ...
    const socialLinks = [
        {
            name: "Phone",
            icon: Phone,
            href: "tel:+01723456789",
            color: "hover:text-red-400"
        },
        {
            name: "GitHub",
            icon: Github,
            href: "https://github.com/raheelarfeen",
            color: "hover:text-gray-400"
        },
        {
            name: "LinkedIn",
            icon: Linkedin,
            href: "https://linkedin.com/in/Raheelarfeen/",
            color: "hover:text-blue-400"
        },
        {
            name: "Twitter",
            icon: Twitter,
            href: "https://x.com/RaheelArfeen",
    ...
    // Quick facts data with icons and text
    const quickFacts = [
                            ...
                            >
                                <motion.div variants={itemVariants}>
                                    ...
                                    <motion.input
                                        ...
                                        className="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-white focus:outline-none focus:border-blue-500 transition-colors duration-300"
                                ...
                                <motion.div variants={itemVariants}>
                                    ...
                                    <motion.textarea
                                        ...
                                        onChange={handleChange}
                                        rows={5}
                                        className="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-white focus:outline-none focus:border-blue-500 transition-colors duration-300 resize-none"
                                ...
                                >
                                    {socialLinks.map((link, index) => (
                                        <motion.a
                                            key={index}
                                            href={link.href}
                                            className={`flex items-center space-x-3 p-4 bg-gray-800 rounded-lg border border-gray-700 hover:border-blue-500/50 transition-all duration-300 group ${link.color}`}
                                            variants={itemVariants}
                                            whileHover={{
                                                scale: 1.05,
                                                y: -5,
